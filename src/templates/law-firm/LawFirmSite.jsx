...
const NAV_LINKS = [
  ...
  { to: "gallery", label: "Cases" },
  { to: "contact", label: "Contact" },
];

export default function LawFirmSite({ content, theme, images = {}, business, base }) {
  const colors = theme?.colors || { primary: "#1A1A1A", secondary: "#252525", accent: "#B8960C" };
  return (
    <div style={{ background: colors.primary, color: "#F0ECE4", minHeight: "100vh" }} className="font-sans">
      <DemoNav business={business} links={NAV_LINKS} accent={colors.accent} bg={colors.primary} base={base} ctaLabel="Request a Consultation" />
      <Routes>
