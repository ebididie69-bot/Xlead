...
export default function DentalClinicSite({ content, theme, images = {}, business, base }) {
  ...
  return (
    <div style={{ background: colors.primary, color: "#0F172A", minHeight: "100vh" }} className="font-sans antialiased">
      <DemoNav business={business} links={NAV_LINKS} accent={colors.accent} bg="#FFFFFF" base={base} ctaLabel="Book a Call" />
      <Routes>
      ...
      <DemoFooter business={business} accent={colors.accent} bg="#0F172A" muted="#94A3B8" />
    </div>
  );
}
