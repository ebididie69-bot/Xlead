...
export default function BakeryCafeSite({ content, theme, images = {}, business, base }) {
  ...
  return (
    <div style={{ background: colors.primary, color: "#2C1810", minHeight: "100vh" }} className="font-sans antialiased">
      <DemoNav business={business} links={NAV_LINKS} accent={colors.accent} bg={colors.primary} base={base} ctaLabel="Order Ahead" />
      <Routes>
      ...
      <DemoFooter business={business} accent={colors.accent} bg={colors.primary} muted="#8B6F5C" />
    </div>
  );
}
