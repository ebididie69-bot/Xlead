...
export default function HotelGuestHouseSite({ content, theme, images = {}, business, base }) {
  const colors = theme?.colors || { primary: "#1B3A2D", secondary: "#234D3C", accent: "#D4AF37" };
  return (
    <div style={{ background: colors.primary, color: "#F5F0E8", minHeight: "100vh" }} className="font-sans">
      <DemoNav business={business} links={NAV_LINKS} accent={colors.accent} bg={colors.primary} base={base} ctaLabel="Reserve a Room" />
      <Routes>
