...
export default function PhotographyStudioSite({ content, theme, images = {}, business, base }) {
  ...
  return (
    <div style={{ background: colors.primary, color: "#FFFFFF", minHeight: "100vh" }} className="font-sans antialiased">
      <DemoNav business={business} links={NAV_LINKS} accent={colors.accent} bg={colors.primary} base={base} ctaLabel="Book a Shoot" />
      <Routes>
      ...
      <DemoFooter business={business} accent={colors.accent} bg={colors.primary} muted="#666666" />
    </div>
  );
}
