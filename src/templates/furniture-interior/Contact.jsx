...
export default function Contact({ content, colors }) {
  ...
  return (
    <div style={{ background: bg, color: "#2C2017", minHeight: "100vh" }}>
      <section className="px-8 pt-28 pb-16 max-w-6xl mx-auto border-b" style={{ borderColor: "rgba(0,0,0,0.08)" }}>
      ...
      <section className="px-8 py-16 max-w-6xl mx-auto grid md:grid-cols-2 gap-16">
        ...
        <Reveal delay={0.15}>
          <div className="p-10 flex flex-col gap-8" style={{ background: surface, borderTop: `2px solid ${accent}` }}>
            <div>
              <h2 className="text-2xl font-bold mb-3" style={{ fontFamily: "Georgia, serif" }}>Book Consultation</h2>
