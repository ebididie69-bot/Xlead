...
export default function FurnitureInteriorSite({ content, theme, images = {}, business, base }) {
  ...
  return (
    <div style={{ background: colors.primary, color: "#1C1917", minHeight: "100vh" }} className="font-sans antialiased">
      <DemoNav business={business} links={NAV_LINKS} accent={colors.accent} bg={colors.primary} base={base} ctaLabel="Book a Consultation" />
      <Routes>
      ...
      <DemoFooter business={business} accent={colors.accent} bg="#1C1917" muted="#A8A29E" />
    </div>
  );
}
