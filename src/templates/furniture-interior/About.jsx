    ...
    <div style={{ background: bg, color: "#2C2017", minHeight: "100vh" }}>
      <section className="px-8 pt-28 pb-16 max-w-6xl mx-auto border-b" style={{ borderColor: "rgba(0,0,0,0.08)" }}>
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight" style={{ fontFamily: "Georgia, serif" }}>Who We Are</h1>
        </motion.div>
      </section>
      ...
      <section className="px-8 py-12 max-w-6xl mx-auto grid md:grid-cols-2 gap-16">
        <Reveal>
          <p className="text-xl leading-relaxed opacity-70" style={{ fontFamily: "Georgia, serif" }}>{content.about}</p>
        </Reveal>
        <Reveal delay={0.1}>
      ...
      {content.testimonials?.length > 0 && (
        <section className="px-8 py-16 border-t" style={{ borderColor: "rgba(0,0,0,0.08)" }}>
          <div className="max-w-6xl mx-auto">
            <Reveal>
              <div className="flex items-center gap-4 mb-12">
                <div className="w-8 h-px" style={{ background: accent }} />
                <h2 className="text-2xl font-bold" style={{ fontFamily: "Georgia, serif" }}>What People Say</h2>
              </div>
            </Reveal>
