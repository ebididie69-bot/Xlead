  ...
  return (
    <div style={{ background: bg, color: "#2C2017", minHeight: "100vh" }}>
      ...
      {content.faq?.length > 0 && (
        <section className="px-8 py-16 max-w-3xl mx-auto border-t" style={{ borderColor: "rgba(0,0,0,0.08)" }}>
          <Reveal>
      ...
      <section className="px-8 py-20 text-center border-t" style={{ borderColor: "rgba(0,0,0,0.08)" }}>
        <Reveal>
