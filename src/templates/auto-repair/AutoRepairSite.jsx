...
const NAV_LINKS = [
  ...
  { to: "about", label: "Our Shop" },
  { to: "gallery", label: "Gallery" },
  { to: "contact", label: "Contact" },
];

export default function AutoRepairSite({ content, theme, images = {}, business, base }) {
  ...
  return (
    <div style={{ background: colors.primary, color: "#E8EAF0", minHeight: "100vh" }} className="font-sans">
      <DemoNav
        business={business}
        links={NAV_LINKS}
