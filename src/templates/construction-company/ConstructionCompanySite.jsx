...
export default function ConstructionCompanySite({ content, theme, images = {}, business, base }) {
  const colors = theme?.colors || { primary: "#1C1C1E", secondary: "#2A2A2C", accent: "#FF6B00" };
  return (
    <div style={{ background: colors.primary, color: "#F0EDE8", minHeight: "100vh" }} className="font-sans">
      <DemoNav business={business} links={NAV_LINKS} accent={colors.accent} bg={colors.primary} base={base} ctaLabel="Get a Quote" />
      <Routes>
